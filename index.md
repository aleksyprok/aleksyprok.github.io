...
Contributed fast-particle physics capabilities to the XGC code, a state-of-the-art gyrokinetic particle-in-cell simulation for exascale HPC architectures. XGC is developed at the Princeton Plasma Physics Laboratory and is primarily written in modern C++ with [Kokkos](https://kokkos.org/kokkos-core-wiki/). This work involved close collaboration with the XGC team whom I learnt a lot from and significantly deepened my expertise in large-scale fusion plasma simulation.
...
* November 17–22, 2024 - Super Computing Conference, Atlanta USA
* October 8-11, 2024 - HPC, Multi GPU Programming and Exascale Technical Workshop, Daresbury Laboratory
* September 17, 2024 - Fusion Computing Workshop, Daresbury Laboratory, [Contributed Talk - XGC for Fusion Turbulence](https://aleksyprok.github.io/images/Fusion_Computing_Workshop_Talk_Sep_2024.pdf)
* May 22-24, 2024 - Hybrid Algorithms, Parallel Libraries and GPU Programming School, Daresbury Laboratory
